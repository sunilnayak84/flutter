...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFEC142);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFF101010);
  ...
  late Color warning = const Color(0xFFE71D0E);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFEC142);
  late Color secondary = const Color(0xFF101010);
